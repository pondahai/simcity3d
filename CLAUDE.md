...
## 遊戲系統
RCI 分區 lvl 0-5 自動生長(需供電+3 格內道路+需求>0);電網 BFS 供電依容量;鐵路(可達性同道路,交通壅塞×0.3、免交通污染,維護 0.5/格 vs 道路 0.18,火車動畫);跨河橋(道路/鐵路/電線水上 5 倍造價,c.br 旗標,拆除還原成水);稅率+交通/警察/消防撥款(月結,交通撥款<100% 時道路/鐵路每月 (1−撥款)×1.2% 機率劣化成瓦礫);六災難(火/洪/龍捲風/地震/巨獸/空難,觸發時 disasterAlert() 紅色橫幅 #alert + 警報音,鳥瞰鏡頭跳往災點、地震除外);時間流速 4 段;人口里程碑;查詢工具;圖層 overlay(power/pollution/crime/landv/traffic;開啟時建築預設壓扁成半格色塊 flat 模式,道路/鐵路/電線照畫,圖例 #bldgChk 勾選框切回立體 ovShowBldg,切換 overlay 要設 dirty 而非只 groundDirty);自動推土機(city.autoDoze 預設開、隨存檔,工具列 tg:true 開關鈕不佔工具選取;開啟時 buildable 含樹林/瓦礫每格 +$1,分區/大建築腳下電線自動拆 +$1 並 toast,交通類不走此路徑以免撞交叉邏輯;part4 showCursor 合法性判定需與 place() 同步);地價價位檔 c.tier(0 低/1 中/2 高,landTier() 門檻 14/30;工業自身污染壓垮地價故門檻另計 3/8)——lvl 管建物規模、tier 管風格,RCI 三分區各有 3 檔×3 變體造型(part3 drawRes/drawCom/drawInd:棚屋/別墅、街邊商場/CBD 金冠塔、鏽工廠/科技園區),tier 只在 simMonth 升降級時取樣避免每月抖動。低檔工業多用圓柱(煙囪/儲槽),CYL_CAP 已擴至 5000。
